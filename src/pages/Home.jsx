        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-secondary-900 dark:text-white">ExamPilot</span>
            </div>
...
const Home = () => {
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <title>ExamPilot - Your AI-Powered Research and Study Partner</title>
        <meta name="description" content="Elevate your studies with ExamPilot. Get AI-powered PDF summarization, automated note collection, and comprehensive study resources to achieve academic excellence." />
      </Helmet>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-xl text-secondary-600 dark:text-secondary-400 max-w-3xl mx-auto">
                        Discover how ExamPilot's specialized AI tools can transform your study and research habits.
                    </p>
                </motion.div>
          ...
          <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-8">
                Join thousands of students who are already using ExamPilot to ace their exams.
              </p>
              <a
                href="/ai-summarizer"
